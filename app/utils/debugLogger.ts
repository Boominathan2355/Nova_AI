...
class DebugLogger {
  ...
  private async _collectAppInfo(): Promise<AppInfo> {
    ...
    try {
      if (typeof window !== 'undefined') {
        ...
        const workbenchStore = (window as any).__nova_workbench_store;
  ...
  private _getCurrentModel(): string {
    try {
      ...
      if (typeof window !== 'undefined') {
        const stored = localStorage.getItem('nova_current_model');
  ...
  private _getCurrentProvider(): string {
    try {
      if (typeof window !== 'undefined') {
        const stored = localStorage.getItem('nova_current_provider');
  ...
  private _getProjectType(): string {
    try {
      if (typeof window !== 'undefined') {
        const stored = localStorage.getItem('nova_project_type');
  ...
  private _getGitInfoFallback(): AppInfo['gitInfo'] {
    try {
      ...
      const stored = localStorage.getItem('nova_git_info');
