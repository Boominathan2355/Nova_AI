...
Nova is initializing your project with the required files using the ${template.name} template.
<novaArtifact id="imported-files" title="${title || 'Create initial files'}" type="bundled">
${filesToImport.files
  .map(
    (file) =>
