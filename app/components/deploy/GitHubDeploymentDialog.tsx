    ...
    try {
      ...
      try {
        ...
        const { data: commitData } = await octokit.git.createCommit({
          owner: connection.user.login,
          repo: sanitizedRepoName,
          message: !repoExists ? 'Initial commit from Nova.diy' : 'Update from Nova.diy',
          tree: treeData.sha,
              ...
              >
                ...
                <div className="relative text-center space-y-4">
                  ...
                  <motion.div
                    ...
                    className="mx-auto w-16 h-16 rounded-xl bg-nova-elements-background-depth-3 flex items-center justify-center text-purple-500"
                  >
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.1 }}
                    className="w-10 h-10 rounded-xl bg-nova-elements-background-depth-3 flex items-center justify-center text-purple-500"
                  >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 px-4 py-2 rounded-lg bg-nova-elements-background-depth-2 dark:bg-nova-elements-background-depth-3 border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark text-nova-elements-textPrimary dark:text-nova-elements-textPrimary-dark placeholder-nova-elements-textTertiary dark:placeholder-nova-elements-textTertiary-dark focus:outline-none focus:ring-2 focus:ring-purple-500"
                        required
                        maxLength={100}
                    ...
                    {repoName && sanitizeRepoName(repoName) !== repoName && (
                      <p className="text-xs text-nova-elements-textSecondary dark:text-nova-elements-textSecondary-dark mt-1">
                        Will be created as:{' '}
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm font-medium text-nova-elements-textPrimary dark:text-nova-elements-textPrimary-dark group-hover:text-purple-500">
                                    {repo.name}
                                  </span>
                                </div>
                                {repo.private && (
                  ...
                  <div className="p-3 bg-nova-elements-background-depth-2 dark:bg-nova-elements-background-depth-3 rounded-lg border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark">
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="rounded border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark text-purple-500 focus:ring-purple-500 dark:bg-nova-elements-background-depth-3"
                      />
                      <label
                        htmlFor="private"
