...
export const DeployButton = ({
  ...
  return (
    <>
      <div className="flex border border-nova-elements-borderColor rounded-md overflow-hidden text-sm">
        <DropdownMenu.Root>
          ...
          >
            ...
            <DropdownMenu.Item
              disabled
              className="flex items-center w-full rounded-md px-4 py-2 text-sm text-nova-elements-textTertiary gap-2 opacity-60 cursor-not-allowed"
            >
              <img
                className="w-5 h-5"
                height="24"
