      ...
      <Dialog.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
        <Dialog.Portal>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[9999]">
            ...
            >
              <Dialog.Content
                className="bg-white dark:bg-nova-elements-background-depth-1 rounded-lg border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark shadow-xl"
                ...
                <div className="p-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-lg font-medium text-nova-elements-textPrimary dark:text-nova-elements-textPrimary-dark">
                          Successfully pushed to GitLab
                        </h3>
                        <p
                          id="success-dialog-description"
                          className="text-sm text-nova-elements-textSecondary dark:text-nova-elements-textSecondary-dark"
                        >
                    ...
                    <Dialog.Close asChild>
                      <button
                        onClick={handleClose}
                        className="p-2 rounded-lg transition-all duration-200 ease-in-out bg-transparent text-nova-elements-textTertiary hover:text-nova-elements-textPrimary dark:text-nova-elements-textTertiary-dark dark:hover:text-nova-elements-textPrimary-dark hover:bg-nova-elements-background-depth-2 dark:hover:bg-nova-elements-background-depth-3 focus:outline-none focus:ring-2 focus:ring-nova-elements-borderColor dark:focus:ring-nova-elements-borderColor-dark"
                      >
                  ...
                  <div className="bg-nova-elements-background-depth-2 dark:bg-nova-elements-background-depth-3 rounded-lg p-4 text-left border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark">
                    <p className="text-sm font-medium text-nova-elements-textPrimary dark:text-nova-elements-textPrimary-dark mb-2 flex items-center gap-2">
                      <span className="i-ph:gitlab-logo w-4 h-4 text-orange-500" />
                      Repository URL
                    </p>
                    <div className="flex items-center gap-2">
                      <code className="flex-1 text-sm bg-nova-elements-background-depth-1 dark:bg-nova-elements-background-depth-4 px-3 py-2 rounded border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark text-nova-elements-textPrimary dark:text-nova-elements-textPrimary-dark font-mono">
                        {createdRepoUrl}
                      </code>
                      <motion.button
                        onClick={() => {
                        ...
                        className="p-2 text-nova-elements-textSecondary hover:text-nova-elements-textPrimary dark:text-nova-elements-textSecondary-dark dark:hover:text-nova-elements-textPrimary-dark bg-nova-elements-background-depth-1 dark:bg-nova-elements-background-depth-4 rounded-lg border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark"
                  ...
                  <div className="bg-nova-elements-background-depth-2 dark:bg-nova-elements-background-depth-3 rounded-lg p-4 border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark">
                    <p className="text-sm font-medium text-nova-elements-textPrimary dark:text-nova-elements-textPrimary-dark mb-2 flex items-center gap-2">
                    ...
                    <div className="max-h-[200px] overflow-y-auto custom-scrollbar pr-2">
                      {pushedFiles.slice(0, 100).map((file) => (
                        <div
                          key={file.path}
                          className="flex items-center justify-between py-1.5 text-sm text-nova-elements-textPrimary dark:text-nova-elements-textPrimary-dark border-b border-nova-elements-borderColor/30 dark:border-nova-elements-borderColor-dark/30 last:border-0"
                        >
                          <span className="font-mono truncate flex-1 text-xs">{file.path}</span>
                          <span className="text-xs px-2 py-0.5 rounded-full bg-nova-elements-background-depth-3 dark:bg-nova-elements-background-depth-4 text-nova-elements-textSecondary dark:text-nova-elements-textSecondary-dark ml-2">
                            {formatSize(file.size)}
                          </span>
                        </div>
                      ))}
                      {pushedFiles.length > 100 && (
                        <div className="py-2 text-center text-xs text-nova-elements-textSecondary dark:text-nova-elements-textSecondary-dark">
                  ...
                  <div className="flex justify-end gap-2 pt-2">
                    ...
                    <motion.button
                      ...
                      className="px-4 py-2 rounded-lg bg-nova-elements-background-depth-2 dark:bg-nova-elements-background-depth-3 text-nova-elements-textSecondary dark:text-nova-elements-textSecondary-dark hover:bg-nova-elements-background-depth-3 dark:hover:bg-nova-elements-background-depth-4 text-sm inline-flex items-center gap-2 border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      <div className="i-ph:copy w-4 h-4" />
                    ...
                    <motion.button
                      onClick={handleClose}
                      className="px-4 py-2 rounded-lg bg-nova-elements-background-depth-2 dark:bg-nova-elements-background-depth-3 text-nova-elements-textSecondary dark:text-nova-elements-textSecondary-dark hover:bg-nova-elements-background-depth-3 dark:hover:bg-nova-elements-background-depth-4 text-sm border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      Close
      ...
      <Dialog.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
        <Dialog.Portal>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[9999]">
            ...
            >
              <Dialog.Content
                className="bg-white dark:bg-nova-elements-background-depth-1 rounded-lg p-6 border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark shadow-xl"
              ...
              >
                ...
                <div className="relative text-center space-y-4">
                  ...
                  <motion.div
                    ...
                    className="mx-auto w-16 h-16 rounded-xl bg-nova-elements-background-depth-3 flex items-center justify-center text-orange-500"
                  >
                  ...
                  <p
                    ...
                    className="text-sm text-nova-elements-textSecondary dark:text-nova-elements-textSecondary-dark max-w-md mx-auto"
                  >
                    To deploy your code to GitLab, you need to connect your GitLab account first.
                  </p>
                  <div className="pt-2 flex justify-center gap-3">
                    <motion.button
                      className="px-4 py-2 rounded-lg bg-nova-elements-background-depth-2 dark:bg-nova-elements-background-depth-3 text-nova-elements-textSecondary dark:text-nova-elements-textSecondary-dark text-sm hover:bg-nova-elements-background-depth-3 dark:hover:bg-nova-elements-background-depth-4 border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      onClick={handleClose}
                    >
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.1 }}
                    className="w-10 h-10 rounded-xl bg-nova-elements-background-depth-3 flex items-center justify-center text-orange-500"
                  >
                    <div className="i-ph:gitlab-logo w-5 h-5" />
                  </motion.div>
                  <div>
                    <Dialog.Title className="text-lg font-medium text-nova-elements-textPrimary dark:text-nova-elements-textPrimary-dark">
                      Deploy to GitLab
                    </Dialog.Title>
                    <p
                ...
                <div className="flex items-center gap-3 mb-6 p-4 bg-nova-elements-background-depth-2 dark:bg-nova-elements-background-depth-3 rounded-lg border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark">
                  <div className="relative">
                    ...
                    <div
                      className="avatar-fallback w-10 h-10 rounded-full bg-nova-elements-background-depth-4 flex items-center justify-center text-nova-elements-textSecondary font-semibold text-sm"
                      style={{
                        display:
                  ...
                  <div>
                    <p className="text-sm font-medium text-nova-elements-textPrimary dark:text-nova-elements-textPrimary-dark">
                      {user.name || user.username}
                    </p>
                    <p className="text-sm text-nova-elements-textSecondary dark:text-nova-elements-textSecondary-dark">
                      @{user.username}
                    </p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <div className="absolute left-3 top-1/2 -translate-y-1/2 text-nova-elements-textTertiary dark:text-nova-elements-textTertiary-dark">
                      ...
                      <input
                        ...
                        className="w-full pl-10 px-4 py-2 rounded-lg bg-nova-elements-background-depth-2 dark:bg-nova-elements-background-depth-3 border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark text-nova-elements-textPrimary dark:text-nova-elements-textPrimary-dark placeholder-nova-elements-textTertiary dark:placeholder-nova-elements-textTertiary-dark focus:outline-none focus:ring-2 focus:ring-orange-500"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between mb-2">
                      <label className="text-sm text-nova-elements-textSecondary dark:text-nova-elements-textSecondary-dark">
                        Recent Repositories
                      </label>
                      <span className="text-xs text-nova-elements-textTertiary dark:text-nova-elements-textTertiary-dark">
                    ...
                    <div className="mb-2">
                      <SearchInput
                        ...
                        className="bg-nova-elements-background-depth-2 dark:bg-nova-elements-background-depth-3 border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark text-sm"
                      />
                    </div>
                        ...
                        {filteredRepos.length === 0 && repoSearchQuery.trim() !== '' ? (
                          ...
                          filteredRepos.map((repo) => (
                            <motion.button
                              ...
                              className="w-full p-3 text-left rounded-lg bg-nova-elements-background-depth-2 dark:bg-nova-elements-background-depth-3 hover:bg-nova-elements-background-depth-3 dark:hover:bg-nova-elements-background-depth-4 transition-colors group border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark hover:border-orange-500/30"
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm font-medium text-nova-elements-textPrimary dark:text-nova-elements-textPrimary-dark group-hover:text-orange-500">
                                    {repo.name}
                                  </span>
                                </div>
                              ...
                              {repo.description && (
                                <p className="mt-1 text-xs text-nova-elements-textSecondary dark:text-nova-elements-textSecondary-dark line-clamp-2">
                                  {repo.description}
                                </p>
                              )}
                  ...
                  <div className="p-3 bg-nova-elements-background-depth-2 dark:bg-nova-elements-background-depth-3 rounded-lg border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark">
                    <div className="flex items-center gap-2">
                      <input
                        type="checkbox"
                        id="private"
                        ...
                        className="rounded border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark text-orange-500 focus:ring-orange-500 dark:bg-nova-elements-background-depth-3"
                      />
                      <label
                        htmlFor="private"
                        className="text-sm text-nova-elements-textPrimary dark:text-nova-elements-textPrimary-dark"
                      >
                        Make repository private
                      </label>
                    </div>
                    <p className="text-xs text-nova-elements-textTertiary dark:text-nova-elements-textTertiary-dark mt-2 ml-6">
