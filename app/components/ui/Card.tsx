  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-nova-elements-borderColor bg-nova-elements-background-depth-1 text-nova-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-nova-elements-textSecondary', className)} {...props} />;
  },
);
