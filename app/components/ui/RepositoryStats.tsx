    ...
    <div className={classNames('space-y-3', className)}>
      ...
      <div className={classNames('grid gap-3', compact ? 'grid-cols-2' : 'grid-cols-2 md:grid-cols-3')}>
        {totalFiles !== undefined && (
          <div className="flex items-center gap-2 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary-dark">
      ...
      {languages && Object.keys(languages).length > 0 && (
        <div className={compact ? 'pt-1' : 'pt-2'}>
          <div className="flex items-center gap-2 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary-dark mb-2">
