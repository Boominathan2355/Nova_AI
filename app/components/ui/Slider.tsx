...
export const Slider = genericMemo(<T,>({ selected, options, setSelected }: SliderProps<T>) => {
  ...
  return (
    <div className="flex items-center flex-wrap shrink-0 gap-1 bg-nova-elements-background-depth-1 overflow-hidden rounded-full p-1">
    ...
    <button
      ...
      className={classNames(
        ...
        selected
          ...
          : 'text-nova-elements-item-contentDefault hover:text-nova-elements-item-contentActive',
      )}
    >
      ...
      {selected && (
        <motion.span
          ...
          className="absolute inset-0 z-0 bg-nova-elements-item-backgroundAccent rounded-full"
        ></motion.span>
      )}
    </button>
  );
