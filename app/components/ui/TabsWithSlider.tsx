        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-nova-elements-background-depth-2 dark:bg-nova-elements-background-depth-3 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary-dark hover:bg-nova-elements-background-depth-3 dark:hover:bg-nova-elements-background-depth-4 border border-nova-elements-borderColor dark:border-nova-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
