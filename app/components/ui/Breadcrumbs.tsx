      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-nova-elements-textPrimary dark:text-nova-elements-textPrimary-dark'
              : 'text-nova-elements-textSecondary dark:text-nova-elements-textSecondary-dark hover:text-nova-elements-textPrimary dark:hover:text-nova-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-nova-elements-textTertiary dark:text-nova-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
