      ...
      <div className={classNames('relative flex items-center w-full', containerClassName)}>
        ...
        <div
          className={classNames(
            'absolute left-3 top-1/2 -translate-y-1/2 text-nova-elements-textTertiary',
            iconClassName,
          )}
        >
          {loading ? (
        ...
        <AnimatePresence>
          {hasValue && showClearButton && (
            <motion.button
              ...
              type="button"
              onClick={onClear}
              className="absolute right-3 top-1/2 -translate-y-1/2 text-nova-elements-textTertiary hover:text-nova-elements-textSecondary p-1 rounded-full hover:bg-nova-elements-background-depth-2"
