...
export const Preview = memo(({ setSelectedElement }: PreviewProps) => {
    ...
    return (
      <div
        ...
        style={{
          ...
          height: '100%',
          cursor: 'ew-resize',
          background: 'var(--nova-elements-background-depth-4, rgba(0,0,0,.3))',
          display: 'flex',
          alignItems: 'center',
        ...
        onMouseOver={(e) =>
          (e.currentTarget.style.background = 'var(--nova-elements-background-depth-4, rgba(0,0,0,.3))')
        }
        onMouseOut={(e) =>
          (e.currentTarget.style.background = 'var(--nova-elements-background-depth-3, rgba(0,0,0,.15))')
        }
  ...
  const GripIcon = () => (
    ...
    >
      <div
        style={{
          color: 'var(--nova-elements-textSecondary, rgba(0,0,0,0.5))',
          fontSize: '10px',
          lineHeight: '5px',
          userSelect: 'none',
          marginLeft: '1px',
  ...
  return (
    <div ref={containerRef} className={`w-full h-full flex flex-col relative`}>
      ...
      <div className="bg-nova-elements-background-depth-2 p-2 flex items-center gap-2">
        <div className="flex items-center gap-2">
          <IconButton icon="i-ph:arrow-clockwise" onClick={reloadPreview} />
          <IconButton
            icon="i-ph:selection"
            onClick={() => setIsSelectionMode(!isSelectionMode)}
            className={isSelectionMode ? 'bg-nova-elements-background-depth-3' : ''}
          />
        </div>

        <div className="flex-grow flex items-center gap-1 bg-nova-elements-preview-addressBar-background border border-nova-elements-borderColor text-nova-elements-preview-addressBar-text rounded-full px-1 py-1 text-sm hover:bg-nova-elements-preview-addressBar-backgroundHover hover:focus-within:bg-nova-elements-preview-addressBar-backgroundActive focus-within:bg-nova-elements-preview-addressBar-backgroundActive focus-within-border-nova-elements-borderColorActive focus-within:text-nova-elements-preview-addressBar-textActive">
          <PortDropdown
        ...
        <div className="flex items-center gap-2">
          ...
          <IconButton
            ...
            className={
              isInspectorMode ? 'bg-nova-elements-background-depth-3 !text-nova-elements-item-contentAccent' : ''
            }
                ...
                <div className="absolute right-0 top-full mt-2 z-50 min-w-[240px] max-h-[400px] overflow-y-auto bg-white dark:bg-black rounded-xl shadow-2xl border border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)] overflow-hidden">
                  <div className="p-3 border-b border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)]">
                    ...
                    <div className="flex flex-col gap-2">
                      <button
                        className={`flex w-full justify-between items-center text-start bg-transparent text-xs text-nova-elements-textTertiary hover:text-nova-elements-textPrimary`}
                        onClick={() => {
                          openInNewTab();
                        }}
                      >
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-nova-elements-textTertiary">Show Device Frame</span>
                        <button
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-nova-elements-textTertiary">Landscape Mode</span>
                        <button
                          className={`w-10 h-5 rounded-full transition-colors duration-200 ${
      ...
      <div className="flex-1 border-t border-nova-elements-borderColor flex justify-center items-center overflow-auto">
        <div
          style={{
            width: isDeviceModeOn ? (showDeviceFrameInPreview ? '100%' : `${widthPercent}%`) : '100%',
            height: '100%',
            overflow: 'auto',
            background: 'var(--nova-elements-background-depth-1)',
            position: 'relative',
            display: 'flex',
            justifyContent: 'center',
            alignItems: 'center',
        ...
        >
          {activePreview ? (
            <>
              {isDeviceModeOn && showDeviceFrameInPreview ? (
                ...
                <iframe
                  ref={iframeRef}
                  title="preview"
                  className="border-none w-full h-full bg-nova-elements-background-depth-1"
                  src={iframeUrl}
                  sandbox="allow-scripts allow-forms allow-popups allow-modals allow-storage-access-by-user-activation allow-same-origin"
            ...
            <div className="flex w-full h-full justify-center items-center bg-nova-elements-background-depth-1 text-nova-elements-textPrimary">
            ...
            <>
              ...
              <div
                style={{
                  ...
                  background: 'var(--nova-elements-background-depth-3, rgba(0,0,0,0.7))',
                  color: 'var(--nova-elements-textPrimary, white)',
                  padding: '2px 8px',
                  borderRadius: '4px',
                  fontSize: '12px',
                  pointerEvents: 'none',
