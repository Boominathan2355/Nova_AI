              ...
              <DropdownMenu.Trigger asChild>
                <span
                  ...
                  className={classNames('flex items-center gap-1.5 cursor-pointer shrink-0', {
                    'text-nova-elements-textTertiary hover:text-nova-elements-textPrimary': !isActive,
                    'text-nova-elements-textPrimary underline': isActive,
                    'pr-4': isLast,
                  })}
                    ...
                    >
                      ...
                      >
                        <div className="rounded-lg overflow-hidden">
                          <div className="max-h-[50vh] min-w-[300px] overflow-scroll bg-nova-elements-background-depth-1 border border-nova-elements-borderColor shadow-sm rounded-lg">
                            <FileTree
                              files={files}
                              hideRoot
                              rootFolder={path}
                        ...
                        <DropdownMenu.Arrow className="fill-nova-elements-borderColor" />
                      </motion.div>
                    </DropdownMenu.Content>
                  </DropdownMenu.Portal>
                )}
