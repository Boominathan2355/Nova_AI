      ...
      <PanelGroup direction="vertical">
        <Panel defaultSize={showTerminal ? DEFAULT_EDITOR_SIZE : 100} minSize={20}>
          <PanelGroup direction="horizontal">
            <Panel defaultSize={20} minSize={15} collapsible className="border-r border-nova-elements-borderColor">
              <div className="h-full">
                <Tabs.Root defaultValue="files" className="flex flex-col h-full">
                  <PanelHeader className="w-full text-sm font-medium text-nova-elements-textSecondary px-1">
                      ...
                      <Tabs.List className="h-full flex-shrink-0 flex items-center">
                        <Tabs.Trigger
                          ...
                          className={classNames(
                            'h-full bg-transparent hover:bg-nova-elements-background-depth-3 py-0.5 px-2 rounded-lg text-sm font-medium text-nova-elements-textTertiary hover:text-nova-elements-textPrimary data-[state=active]:text-nova-elements-textPrimary',
                          )}
                        >
                          Files
                        </Tabs.Trigger>
