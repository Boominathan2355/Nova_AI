  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-nova-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-nova-elements-background-depth-2 border-y border-nova-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-nova-elements-terminals-buttonBackground text-nova-elements-textSecondary hover:text-nova-elements-textPrimary':
                            isActive,
                          'bg-nova-elements-background-depth-2 text-nova-elements-textSecondary hover:bg-nova-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-nova-elements-terminals-buttonBackground text-nova-elements-textPrimary': isActive,
                            'bg-nova-elements-background-depth-2 text-nova-elements-textSecondary hover:bg-nova-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-nova-elements-textTertiary hover:text-nova-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachNovaTerminal(terminal);
                  } else {
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachNovaTerminal(terminal)}
