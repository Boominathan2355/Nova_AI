      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            />
            <h3 className="text-base font-medium text-nova-elements-textPrimary">Vercel Connection</h3>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="mt-2 text-sm text-nova-elements-textSecondary">
                ...
                <div className="mt-2 text-xs text-nova-elements-textSecondary bg-nova-elements-background-depth-1 p-2 rounded">
                  <p className="flex items-center gap-1">
                    <span className="i-ph:lightbulb w-3.5 h-3.5 text-nova-elements-icon-success" />
                    <span className="font-medium">Tip:</span> You can also set{' '}
                    <code className="px-1 py-0.5 bg-nova-elements-background-depth-2 rounded text-xs">
            ...
            {fetchingStats ? (
              ...
              <div>
                <button
                  ...
                  className="w-full bg-transparent text-left text-sm font-medium text-nova-elements-textPrimary mb-3 flex items-center gap-2"
                >
                ...
                {isProjectsExpanded && connection.stats?.projects?.length ? (
                  <div className="grid gap-3">
                    {connection.stats.projects.map((project) => (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block p-4 rounded-lg border border-nova-elements-borderColor hover:border-nova-elements-borderColorActive transition-colors"
                      >
                        <div className="flex items-center justify-between">
                          <div>
                              ...
                              {project.targets?.production?.alias && project.targets.production.alias.length > 0 ? (
                                <>
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="hover:text-nova-elements-borderColorActive"
                                  >
                          ...
                          {project.framework && (
                            <div className="text-xs text-nova-elements-textSecondary px-2 py-1 rounded-md bg-[#F0F0F0] dark:bg-[#252525]">
                              <span className="flex items-center gap-1">
                  ...
                  <div className="text-sm text-nova-elements-textSecondary flex items-center gap-2">
