          ...
          <div className="space-y-4 mt-4">
            ...
            {connection.stats?.projects?.length ? (
              <div className="mb-6 p-4 bg-nova-elements-background-depth-1 rounded-lg border border-nova-elements-borderColor">
                <h4 className="text-sm font-medium text-nova-elements-textPrimary mb-3">Vercel Overview</h4>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-xs text-nova-elements-textSecondary">Deployed Projects</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-nova-elements-textPrimary">
                      {new Set(connection.stats.projects.map((p) => p.framework).filter(Boolean)).size}
                    </div>
                    <div className="text-xs text-nova-elements-textSecondary">Frameworks Used</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-nova-elements-textPrimary">
                      {connection.stats.projects.filter((p) => p.latestDeployments?.[0]?.state === 'READY').length}
                    </div>
                    <div className="text-xs text-nova-elements-textSecondary">Active Deployments</div>
                  </div>
                </div>
              </div>
            ) : null}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-nova-elements-background-depth-2 p-3 rounded-lg border border-nova-elements-borderColor">
                    <h6 className="text-xs font-medium text-nova-elements-textPrimary flex items-center gap-2 mb-2">
                      <div className="i-ph:rocket w-4 h-4 text-nova-elements-item-contentAccent" />
                      Deployment Health
                    </h6>
                  ...
                  <div className="bg-nova-elements-background-depth-2 p-3 rounded-lg border border-nova-elements-borderColor">
                    <h6 className="text-xs font-medium text-nova-elements-textPrimary flex items-center gap-2 mb-2">
                      <div className="i-ph:chart-bar w-4 h-4 text-nova-elements-item-contentAccent" />
                  ...
                  <div className="bg-nova-elements-background-depth-2 p-3 rounded-lg border border-nova-elements-borderColor">
                    <h6 className="text-xs font-medium text-nova-elements-textPrimary flex items-center gap-2 mb-2">
                      <div className="i-ph:activity w-4 h-4 text-nova-elements-item-contentAccent" />
                      Activity Summary
                    </h6>
                    <div className="space-y-1">
                      {(() => {
            ...
            {connection.stats?.projects?.length ? (
              <div className="mb-6">
                <h4 className="text-sm font-medium text-nova-elements-textPrimary mb-2">Project Health Overview</h4>
            ...
            {connection.stats?.projects?.length ? (
              <div className="grid gap-3">
                {connection.stats.projects.map((project) => (
                  <div
                    key={project.id}
                    className="p-4 rounded-lg border border-nova-elements-borderColor hover:border-nova-elements-borderColorActive/70 transition-colors bg-nova-elements-background-depth-1"
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <h5 className="text-sm font-medium text-nova-elements-textPrimary flex items-center gap-2">
                          <div className="i-ph:globe w-4 h-4 text-nova-elements-borderColorActive" />
                          {project.name}
                        </h5>
                          ...
                          {project.targets?.production?.alias && project.targets.production.alias.length > 0 ? (
                            <>
                              <a
                                ...
                                className="hover:text-nova-elements-borderColorActive underline"
                              >
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 mt-3 pt-3 border-t border-nova-elements-borderColor">
                          <div className="text-center">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {project.framework && (
                          <div className="text-xs text-nova-elements-textSecondary px-2 py-1 rounded-md bg-nova-elements-background-depth-2">
                            <span className="flex items-center gap-1">
                    ...
                    <div className="flex items-center flex-wrap gap-1 mt-3 pt-3 border-t border-nova-elements-borderColor">
        ...
        <div className="p-6 space-y-6">
          {!connection.user ? (
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm text-nova-elements-textSecondary mb-2">Personal Access Token</label>
                <input
                  type="password"
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-nova-elements-background-depth-1 dark:bg-nova-elements-background-depth-1 rounded-lg">
                  <img
                    ...
                    alt="User Avatar"
                    className="w-12 h-12 rounded-full border-2 border-nova-elements-borderColorActive"
                  />
                  <div className="flex-1">
                    <h4 className="text-sm font-medium text-nova-elements-textPrimary">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-3 bg-nova-elements-background-depth-1 rounded-lg border border-nova-elements-borderColor">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="i-ph:buildings w-4 h-4 text-nova-elements-item-contentAccent" />
                      <span className="text-xs font-medium text-nova-elements-textPrimary">Projects</span>
                    </div>
                  ...
                  <div className="p-3 bg-nova-elements-background-depth-1 rounded-lg border border-nova-elements-borderColor">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs font-medium text-nova-elements-textPrimary">Domains</span>
                    </div>
                    <div className="text-sm text-nova-elements-textSecondary">
                  ...
                  <div className="p-3 bg-nova-elements-background-depth-1 rounded-lg border border-nova-elements-borderColor">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="i-ph:activity w-4 h-4 text-nova-elements-item-contentAccent" />
                      <span className="text-xs font-medium text-nova-elements-textPrimary">Usage</span>
                    </div>
                    <div className="text-sm text-nova-elements-textSecondary">
