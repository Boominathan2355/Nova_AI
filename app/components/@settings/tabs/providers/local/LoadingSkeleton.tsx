  ...
  return (
    <div className={classNames('space-y-2', className)}>
      {Array.from({ length: lines }).map((_, i) => (
        <div
          key={i}
          className={classNames('bg-nova-elements-background-depth-3 rounded', height, 'animate-pulse')}
  ...
  return (
    <div
      className={classNames(
        ...
        'border-nova-elements-borderColor',
        className,
      )}
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3 flex-1">
          <div className="w-3 h-3 rounded-full bg-nova-elements-textTertiary animate-pulse" />
          <div className="space-y-2 flex-1">
            <LoadingSkeleton height="h-5" lines={1} className="w-3/4" />
            <LoadingSkeleton height="h-3" lines={1} className="w-1/2" />
          </div>
        </div>
        <div className="w-4 h-4 bg-nova-elements-textTertiary rounded animate-pulse" />
      </div>
    </div>
  );
}
...
export function ProviderCardSkeleton({ className }: ProviderCardSkeletonProps) {
  return (
    <div className={classNames('bg-nova-elements-background-depth-2 rounded-xl p-5', className)}>
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-4 flex-1">
          <div className="w-12 h-12 rounded-xl bg-nova-elements-background-depth-3 animate-pulse" />
        ...
        <div className="w-10 h-6 bg-nova-elements-background-depth-3 rounded-full animate-pulse" />
      </div>
    </div>
  );
}
    ...
    <div className={classNames('space-y-6', className)}>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <div className="w-24 h-8 bg-nova-elements-background-depth-3 rounded-lg animate-pulse" />
          <div className="w-16 h-8 bg-nova-elements-background-depth-3 rounded-lg animate-pulse" />
        </div>
      </div>
