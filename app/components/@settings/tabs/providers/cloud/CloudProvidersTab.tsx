...
const CloudProvidersTab = () => {
  ...
  useEffect(() => {
    const newFilteredProviders = Object.entries(settings.providers || {})
      .filter(([key]) => !['LlamaCpp', 'LMStudio', 'OpenAILike'].includes(key))
      .map(([key, value]) => ({
        name: key,
      ...
      >
        <div className="flex items-center justify-between gap-4 mt-8 mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h4 className="text-md font-medium text-nova-elements-textPrimary">Cloud Providers</h4>
              <p className="text-sm text-nova-elements-textSecondary">Connect to cloud-based AI models and services</p>
            </div>
          </div>

          <div className="flex items-center gap-2">
            <span className="text-sm text-nova-elements-textSecondary">Enable All Cloud</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filteredProviders.map((provider, index) => (
            <motion.div
              key={provider.name}
              className={classNames(
                'rounded-lg border bg-nova-elements-background text-nova-elements-textPrimary shadow-sm',
              ...
              <div className="flex items-start gap-4 p-4">
                <motion.div
                  className={classNames(
                    ...
                    'bg-nova-elements-background-depth-3 group-hover:bg-nova-elements-background-depth-4',
                    'transition-all duration-200',
                    provider.settings.enabled ? 'text-purple-500' : 'text-nova-elements-textSecondary',
                  )}
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-4 mb-2">
                    <div>
                      <h4 className="text-sm font-medium text-nova-elements-textPrimary group-hover:text-purple-500 transition-colors">
                        {provider.name}
                      </h4>
                      <p className="text-xs text-nova-elements-textSecondary mt-0.5">
                        ...
                        {editingProvider === provider.name ? (
                          <input
                            ...
                            className={classNames(
                              ...
                              'bg-nova-elements-background-depth-3 border border-nova-elements-borderColor',
                          ...
                          >
                            <div className="flex items-center gap-2 text-nova-elements-textSecondary">
