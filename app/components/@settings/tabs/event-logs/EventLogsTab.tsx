...
export function EventLogsTab() {
  ...
  const exportAsPDF = () => {
    try {
      ...
      // Add subtitle with Nova
      doc.setFontSize(12);
      doc.setFont('helvetica', 'normal');
      doc.text('Nova - AI Development Platform', margin, 45);
      yPos = 70;
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        // Add footer text
        doc.text('Generated by Nova', margin, doc.internal.pageSize.getHeight() - 10);
              ...
              {exportFormats.map((format) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-xs text-nova-elements-textSecondary mt-0.5">
