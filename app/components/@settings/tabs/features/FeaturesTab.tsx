      ...
      <div className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={classNames(feature.icon, 'w-5 h-5 text-nova-elements-textSecondary')} />
            <div className="flex items-center gap-2">
              <h4 className="font-medium text-nova-elements-textPrimary">{feature.title}</h4>
              {feature.beta && (
        ...
        <p className="mt-2 text-sm text-nova-elements-textSecondary">{feature.description}</p>
        {feature.tooltip && <p className="mt-1 text-xs text-nova-elements-textTertiary">{feature.tooltip}</p>}
      </div>
    </motion.div>
  ),
);
  ...
  ({
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          <h3 className="text-lg font-medium text-nova-elements-textPrimary">{title}</h3>
          <p className="text-sm text-nova-elements-textSecondary">{description}</p>
        </div>
      </div>
