...
export function DataVisualization({ chats }: DataVisualizationProps) {
  ...
  const chartColors = {
    ...
    text: getThemeColor('--nova-elements-textPrimary'),
    textSecondary: getThemeColor('--nova-elements-textSecondary'),
    background: getThemeColor('--nova-elements-bg-depth-1'),
    accent: getThemeColor('--nova-elements-button-primary-text'),
    border: getThemeColor('--nova-elements-borderColor'),
  };

  const getChartColors = (index: number) => {
    // Define color palettes based on Nova design tokens
    const baseColors = [
      // Indigo
      {
        base: getThemeColor('--nova-elements-button-primary-text'),
      },
      ...
      // Green
      {
        base: getThemeColor('--nova-elements-icon-success'),
      },
  ...
  if (chats.length === 0) {
    return (
      <div className="text-center py-8">
        <div className="i-ph-chart-line-duotone w-12 h-12 mx-auto mb-4 text-nova-elements-textTertiary opacity-80" />
        <h3 className="text-lg font-medium text-nova-elements-textPrimary mb-2">No Data Available</h3>
        <p className="text-nova-elements-textSecondary">
  ...
  const cardClasses = classNames(
    ...
    'bg-nova-elements-bg-depth-1',
    'border border-nova-elements-borderColor',
  );

  const statClasses = classNames('text-3xl font-bold text-nova-elements-textPrimary', 'flex items-center gap-3');

  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-nova-elements-textPrimary mb-4">Total Chats</h3>
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-nova-elements-textPrimary mb-4">Total Messages</h3>
          <div className={statClasses}>
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-nova-elements-textPrimary mb-4">Avg. Messages/Chat</h3>
          <div className={statClasses}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-nova-elements-textPrimary mb-6">Chat History</h3>
          <div className="h-64">
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-nova-elements-textPrimary mb-6">Message Distribution</h3>
          <div className="h-64">
      ...
      {apiKeyUsage.length > 0 && (
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-nova-elements-textPrimary mb-6">API Usage by Provider</h3>
          <div className="h-64">
