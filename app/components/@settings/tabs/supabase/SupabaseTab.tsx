...
export default function SupabaseTab() {
  ...
  const renderProjects = () => {
    if (fetchingStats) {
      return (
        <div className="flex items-center gap-2 text-sm text-nova-elements-textSecondary">
        ...
        <CollapsibleTrigger asChild>
          <div className="flex items-center justify-between p-4 rounded-lg bg-nova-elements-background dark:bg-nova-elements-background-depth-2 border border-nova-elements-borderColor dark:border-nova-elements-borderColor hover:border-nova-elements-borderColorActive/70 dark:hover:border-nova-elements-borderColorActive/70 transition-all duration-200 cursor-pointer">
            <div className="flex items-center gap-2">
              <div className="i-ph:database w-4 h-4 text-nova-elements-item-contentAccent" />
              <span className="text-sm font-medium text-nova-elements-textPrimary">
          ...
          <div className="space-y-4 mt-4">
            ...
            {connection.stats?.projects?.length ? (
              <div className="mb-6 p-4 bg-nova-elements-background-depth-1 rounded-lg border border-nova-elements-borderColor">
                <h4 className="text-sm font-medium text-nova-elements-textPrimary mb-3">Supabase Overview</h4>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-nova-elements-textPrimary">
                      {connection.stats.totalProjects}
                    </div>
                    <div className="text-xs text-nova-elements-textSecondary">Total Projects</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-nova-elements-textPrimary">
                      {connection.stats.projects.filter((p: SupabaseProject) => p.status === 'ACTIVE_HEALTHY').length}
                    </div>
                    <div className="text-xs text-nova-elements-textSecondary">Active Projects</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-nova-elements-textPrimary">
                      {new Set(connection.stats.projects.map((p: SupabaseProject) => p.region)).size}
                    </div>
                    <div className="text-xs text-nova-elements-textSecondary">Regions Used</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-nova-elements-textPrimary">
                      {connection.stats.projects.filter((p: SupabaseProject) => p.status !== 'ACTIVE_HEALTHY').length}
                    </div>
                    <div className="text-xs text-nova-elements-textSecondary">Inactive Projects</div>
                  </div>
                </div>
              </div>
            ) : null}
            ...
            {connection.stats?.projects?.length ? (
              <div className="grid gap-3">
                {connection.stats.projects.map((project: SupabaseProject) => (
                  <div
                    key={project.id}
                    className={classNames(
                      'p-4 rounded-lg border transition-colors bg-nova-elements-background-depth-1 cursor-pointer',
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <h5 className="text-sm font-medium text-nova-elements-textPrimary flex items-center gap-2">
                          <div className="i-ph:database w-4 h-4 text-nova-elements-borderColorActive" />
                          {project.name}
                        </h5>
                        <div className="flex items-center gap-2 mt-2 text-xs text-nova-elements-textSecondary">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-3 pt-3 border-t border-nova-elements-borderColor">
                          <div className="text-center">
                            <div className="text-sm font-semibold text-nova-elements-textPrimary">
                              {project.stats?.database?.tables ?? '--'}
                            </div>
                            <div className="text-xs text-nova-elements-textSecondary flex items-center justify-center gap-1">
                    ...
                    {selectedProjectId === project.id && (
                      <div className="space-y-4 mt-4 pt-4 border-t border-nova-elements-borderColor">
                        <div className="flex flex-wrap items-center gap-1">
                          {projectActions.map((action) => (
                            <Button
                              ...
                              className="flex items-center gap-1 text-xs px-2 py-1 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary"
                            >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="bg-nova-elements-background-depth-2 p-3 rounded-lg space-y-2">
                            <h6 className="text-xs font-medium text-nova-elements-textPrimary flex items-center gap-2">
                              <div className="i-ph:database w-4 h-4 text-nova-elements-item-contentAccent" />
                              Database Schema
                            </h6>
                            <div className="space-y-1 text-xs text-nova-elements-textSecondary">
                          ...
                          <div className="bg-nova-elements-background-depth-2 p-3 rounded-lg space-y-2">
                            <h6 className="text-xs font-medium text-nova-elements-textPrimary flex items-center gap-2">
                              <div className="i-ph:folder w-4 h-4 text-nova-elements-item-contentAccent" />
                              Storage
                            </h6>
                            <div className="space-y-1 text-xs text-nova-elements-textSecondary">
                              <div className="flex justify-between">
                        ...
                        {connection.credentials && (
                          <div className="bg-nova-elements-background-depth-2 p-3 rounded-lg space-y-2">
                            <h6 className="text-xs font-medium text-nova-elements-textPrimary flex items-center gap-2">
                              <div className="i-ph:key w-4 h-4 text-nova-elements-item-contentAccent" />
                              Project Credentials
                            </h6>
                            <div className="space-y-2">
                              <div>
                                <label className="text-xs text-nova-elements-textSecondary">Supabase URL:</label>
                                <div className="flex items-center gap-2 mt-1">
                                  <input
                                    type="text"
                                    value={connection.credentials.supabaseUrl || ''}
                                    readOnly
                                    className="flex-1 px-2 py-1 text-xs bg-nova-elements-background border border-nova-elements-borderColor rounded"
                                  />
                                  <Button
                                    size="icon"
                                    variant="outline"
                              ...
                              <div>
                                <label className="text-xs text-nova-elements-textSecondary">Anon Key:</label>
                                <div className="flex items-center gap-2 mt-1">
                                  <input
                                    type="password"
              ...
              <div className="text-sm text-nova-elements-textSecondary flex items-center gap-2 p-4">
        ...
        <div className="p-6 space-y-6">
          {!connection.user ? (
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm text-nova-elements-textSecondary mb-2">Access Token</label>
                <input
                  type="password"
                  value={tokenInput}
            ...
            <div className="space-y-6">
              ...
              {connection.user && (
                <div className="space-y-4">
                  <div className="flex items-center gap-4 p-4 bg-nova-elements-background-depth-1 dark:bg-nova-elements-background-depth-1 rounded-lg">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center">
                      <div className="i-ph:user w-6 h-6 text-white" />
                    </div>
                    <div className="flex-1">
                      <h4 className="text-sm font-medium text-nova-elements-textPrimary">{connection.user.email}</h4>
                      <p className="text-sm text-nova-elements-textSecondary">
                        {connection.user.role} • Member since{' '}
                        {new Date(connection.user.created_at).toLocaleDateString()}
                      </p>
                      <div className="flex items-center gap-4 mt-2 text-xs text-nova-elements-textSecondary">
                        <span className="flex items-center gap-1">
                  ...
                  <div className="mb-6 space-y-4">
                    <h4 className="text-sm font-medium text-nova-elements-textPrimary">Performance Analytics</h4>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-nova-elements-background-depth-2 p-3 rounded-lg border border-nova-elements-borderColor">
                        <h6 className="text-xs font-medium text-nova-elements-textPrimary flex items-center gap-2 mb-2">
                          <div className="i-ph:chart-line w-4 h-4 text-nova-elements-item-contentAccent" />
                          Database Health
                        </h6>
                      ...
                      <div className="bg-nova-elements-background-depth-2 p-3 rounded-lg border border-nova-elements-borderColor">
                        <h6 className="text-xs font-medium text-nova-elements-textPrimary flex items-center gap-2 mb-2">
                          <div className="i-ph:shield-check w-4 h-4 text-nova-elements-item-contentAccent" />
                          Auth & Security
                        </h6>
                        <div className="space-y-1">
                          {(() => {
                      ...
                      <div className="bg-nova-elements-background-depth-2 p-3 rounded-lg border border-nova-elements-borderColor">
                        <h6 className="text-xs font-medium text-nova-elements-textPrimary flex items-center gap-2 mb-2">
                          <div className="i-ph:globe w-4 h-4 text-nova-elements-item-contentAccent" />
                  ...
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-nova-elements-textPrimary mb-2">Resource Overview</h4>
                  ...
                  {/* Usage Metrics */}
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="p-3 bg-nova-elements-background-depth-1 rounded-lg border border-nova-elements-borderColor">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="i-ph:database w-4 h-4 text-nova-elements-item-contentAccent" />
                        <span className="text-xs font-medium text-nova-elements-textPrimary">Database</span>
                      </div>
                      <div className="text-sm text-nova-elements-textSecondary">
                        <div>
                          Tables:{' '}
                          {connection.stats?.projects?.reduce((sum, p) => sum + (p.stats?.database?.tables || 0), 0) ||
                            '--'}
                    ...
                    <div className="p-3 bg-nova-elements-background-depth-1 rounded-lg border border-nova-elements-borderColor">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="i-ph:folder w-4 h-4 text-nova-elements-item-contentAccent" />
                        <span className="text-xs font-medium text-nova-elements-textPrimary">Storage</span>
                      </div>
                      <div className="text-sm text-nova-elements-textSecondary">
                        <div>
                          Buckets:{' '}
                    ...
                    <div className="p-3 bg-nova-elements-background-depth-1 rounded-lg border border-nova-elements-borderColor">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="i-ph:code w-4 h-4 text-nova-elements-item-contentAccent" />
                        <span className="text-xs font-medium text-nova-elements-textPrimary">Functions</span>
                      </div>
                      <div className="text-sm text-nova-elements-textSecondary">
                        <div>
                          Deployed:{' '}
