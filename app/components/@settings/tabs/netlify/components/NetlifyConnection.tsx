...
export default function NetlifyConnection() {
          ...
          <CollapsibleContent className="overflow-hidden">
            <div className="space-y-4 mt-4">
              <div className="flex flex-wrap items-center gap-4">
                ...
                >
                  <BuildingLibraryIcon className="h-4 w-4 text-nova-elements-item-contentAccent" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary"
                >
                  <RocketLaunchIcon className="h-4 w-4 text-nova-elements-item-contentAccent" />
                ...
                {lastUpdated && (
                  <Badge
                    ...
                    className="flex items-center gap-1 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary"
                  >
                    <ClockIcon className="h-4 w-4 text-nova-elements-item-contentAccent" />
                  ...
                  <div className="bg-nova-elements-background dark:bg-nova-elements-background-depth-1 border border-nova-elements-borderColor dark:border-nova-elements-borderColor rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-sm font-medium flex items-center gap-2 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary">
                        <BuildingLibraryIcon className="h-4 w-4 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                        Your Sites
                      </h4>
                      <Button
                        variant="outline"
                      ...
                      >
                        <ArrowPathIcon
                          className={classNames(
                            'h-4 w-4 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent',
                    ...
                    <div className="space-y-3">
                      {sites.map((site, index) => (
                        <div
                          key={site.id}
                          className={classNames(
                            'bg-nova-elements-background dark:bg-nova-elements-background-depth-1 border rounded-lg p-4 transition-all',
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <CloudIcon className="h-5 w-5 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                          ...
                          <div className="mt-3 flex items-center gap-2">
                            ...
                            >
                              <CloudIcon className="h-3 w-3 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                                ...
                                <div className="flex items-center gap-2">
                                  {siteActions.map((action) => (
                                    <Button
                                      ...
                                      className="flex items-center gap-1 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary"
                                    >
                                      <action.icon className="h-4 w-4 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                                      {action.name}
                                    </Button>
                                  ))}
                                </div>
                              ...
                              {site.published_deploy && (
                                <div className="mt-3 text-sm">
                                  <div className="flex items-center gap-1">
                                    <ClockIcon className="h-4 w-4 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                                  ...
                                  {site.published_deploy.branch && (
                                    <div className="flex items-center gap-1 mt-1">
                                      <CodeBracketIcon className="h-4 w-4 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                                      <span className="text-nova-elements-textSecondary dark:text-nova-elements-textSecondary">
                          ...
                          >
                            ...
                            {deploy.branch && (
                              <div className="mt-2 text-xs text-nova-elements-textSecondary dark:text-nova-elements-textSecondary flex items-center gap-1">
                                <CodeBracketIcon className="h-3 w-3 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                                <span className="text-nova-elements-textSecondary dark:text-nova-elements-textSecondary">
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {deploy.state === 'ready' ? (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary"
                                >
                                  <LockClosedIcon className="h-4 w-4 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                                  Lock
                                </Button>
                              ) : (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary"
                                >
                                  <LockOpenIcon className="h-4 w-4 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                                  Unlock
                                </Button>
                              )}
                            </div>
                      ...
                      <div className="space-y-2">
                        {builds.map((build) => (
                          ...
                          >
                            ...
                            {build.error && (
                              <div className="mt-2 text-xs text-nova-elements-textDestructive dark:text-nova-elements-textDestructive flex items-center gap-1">
                                <XCircleIcon className="h-3 w-3 text-nova-elements-textDestructive dark:text-nova-elements-textDestructive" />
                                Error: {build.error}
                              </div>
                            )}
                          </div>
  ...
  return (
    <div className="space-y-6 bg-nova-elements-background dark:bg-nova-elements-background border border-nova-elements-borderColor dark:border-nova-elements-borderColor rounded-lg">
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium text-nova-elements-textPrimary">Netlify Connection</h2>
          </div>
        </div>
