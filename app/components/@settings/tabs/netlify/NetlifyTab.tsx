      ...
      <div className="mt-6">
        <Collapsible open={isStatsOpen} onOpenChange={setIsStatsOpen}>
          <CollapsibleTrigger asChild>
            <div className="flex items-center justify-between p-4 rounded-lg bg-nova-elements-background dark:bg-nova-elements-background-depth-2 border border-nova-elements-borderColor dark:border-nova-elements-borderColor hover:border-nova-elements-borderColorActive/70 dark:hover:border-nova-elements-borderColorActive/70 transition-all duration-200 cursor-pointer">
              <div className="flex items-center gap-2">
                <div className="i-ph:chart-bar w-4 h-4 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                <span className="text-sm font-medium text-nova-elements-textPrimary dark:text-nova-elements-textPrimary">
                  Netlify Stats
                </span>
              </div>
              <div
                className={classNames(
                  'i-ph:caret-down w-4 h-4 transform transition-transform duration-200 text-nova-elements-textSecondary',
          ...
          <CollapsibleContent className="overflow-hidden">
            <div className="space-y-4 mt-4">
              ...
              <div className="mb-6 p-4 bg-nova-elements-background-depth-1 rounded-lg border border-nova-elements-borderColor">
                <h4 className="text-sm font-medium text-nova-elements-textPrimary mb-3">Netlify Overview</h4>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-nova-elements-textPrimary">
                      {connection.stats.totalSites}
                    </div>
                    <div className="text-xs text-nova-elements-textSecondary">Total Sites</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-nova-elements-textPrimary">
                      {connection.stats.totalDeploys || deploymentCount}
                    </div>
                    <div className="text-xs text-nova-elements-textSecondary">Total Deployments</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-nova-elements-textPrimary">
                      {connection.stats.totalBuilds || 0}
                    </div>
                    <div className="text-xs text-nova-elements-textSecondary">Total Builds</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-nova-elements-textPrimary">
                      {sites.filter((site) => site.published_deploy?.state === 'ready').length}
                    </div>
                    <div className="text-xs text-nova-elements-textSecondary">Live Sites</div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6 space-y-4">
                <h4 className="text-sm font-medium text-nova-elements-textPrimary">Deployment Analytics</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-nova-elements-background-depth-2 p-3 rounded-lg border border-nova-elements-borderColor">
                    <h6 className="text-xs font-medium text-nova-elements-textPrimary flex items-center gap-2 mb-2">
                      <div className="i-ph:chart-pie w-4 h-4 text-nova-elements-item-contentAccent" />
                      Success Rate
                    </h6>
                    <div className="space-y-1">
                      {(() => {
                        ...
                        <div key={idx} className="flex justify-between text-xs">
                          <span className="text-nova-elements-textSecondary">{item.label}:</span>
                          <span className="text-nova-elements-textPrimary font-medium">{item.value}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="bg-nova-elements-background-depth-2 p-3 rounded-lg border border-nova-elements-borderColor">
                    <h6 className="text-xs font-medium text-nova-elements-textPrimary flex items-center gap-2 mb-2">
                      <div className="i-ph:clock w-4 h-4 text-nova-elements-item-contentAccent" />
                      Recent Activity
                    </h6>
                    <div className="space-y-1">
                      {(() => {
              ...
              {/* Site Health Metrics */}
              <div className="mb-6">
                <h4 className="text-sm font-medium text-nova-elements-textPrimary mb-2">Site Health Overview</h4>
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  {(() => {
                    ...
                    <div
                      key={index}
                      className={`flex flex-col p-3 rounded-lg border border-nova-elements-borderColor ${metric.bgColor}`}
                    >
                      <div className="flex items-center gap-2 mb-1">
                        <div className={`${metric.icon} w-4 h-4 ${metric.color}`} />
                        <span className="text-xs text-nova-elements-textSecondary">{metric.label}</span>
                      </div>
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Badge
                  variant="outline"
                  className="flex items-center gap-1 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary"
                >
                  <div className="i-ph:buildings w-4 h-4 text-nova-elements-item-contentAccent" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary"
                >
                  <div className="i-ph:rocket-launch w-4 h-4 text-nova-elements-item-contentAccent" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary"
                >
                  <div className="i-ph:hammer w-4 h-4 text-nova-elements-item-contentAccent" />
              ...
              {sites.length > 0 && (
                <div className="mt-4 space-y-4">
                  <div className="bg-nova-elements-background dark:bg-nova-elements-background-depth-1 border border-nova-elements-borderColor dark:border-nova-elements-borderColor rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-4">
                        <h4 className="text-sm font-medium flex items-center gap-2 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary">
                          <div className="i-ph:buildings w-4 h-4 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                          Your Sites ({sites.length})
                        </h4>
                        {sites.length > 8 && (
                          <button
                            onClick={() => setIsSitesExpanded(!isSitesExpanded)}
                            className="text-xs text-nova-elements-textSecondary hover:text-nova-elements-textPrimary transition-colors"
                          >
                      ...
                      <Button
                        ...
                        className="flex items-center gap-2 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary hover:bg-nova-elements-item-backgroundActive/10"
                      >
                        <div
                          className={classNames(
                            'i-ph:arrows-clockwise w-4 h-4 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent',
                    ...
                    <div className="space-y-3">
                      {(isSitesExpanded ? sites : sites.slice(0, 8)).map((site, index) => (
                        <div
                          key={site.id}
                          className={classNames(
                            'bg-nova-elements-background dark:bg-nova-elements-background-depth-1 border rounded-lg p-4 transition-all cursor-pointer',
                            activeSiteIndex === index
                              ? 'border-nova-elements-item-contentAccent bg-nova-elements-item-backgroundActive/10'
                              : 'border-nova-elements-borderColor hover:border-nova-elements-borderColorActive/70',
                          )}
                          onClick={() => {
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <div className="i-ph:cloud w-5 h-5 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                              <span className="font-medium text-nova-elements-textPrimary dark:text-nova-elements-textPrimary">
                                {site.name}
                              </span>
                            </div>
                            <div className="flex items-center gap-2">
                              ...
                              >
                                ...
                                <span className="text-nova-elements-textPrimary dark:text-nova-elements-textPrimary">
                          ...
                          <div className="mt-3 space-y-2">
                            <div className="flex items-center gap-2">
                              <a
                                ...
                                className="text-sm flex items-center gap-1 transition-colors text-nova-elements-link-text hover:text-nova-elements-link-textHover dark:text-white dark:hover:text-nova-elements-link-textHover"
                                onClick={(e) => e.stopPropagation()}
                              >
                                <div className="i-ph:cloud w-3 h-3 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                            ...
                            <div className="flex items-center gap-4 text-xs text-nova-elements-textSecondary">
                              {site.published_deploy?.framework && (
                                <div className="flex items-center gap-1">
                                  <div className="i-ph:cube w-3 h-3 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                                  <span>{site.published_deploy.framework}</span>
                                </div>
                              )}
                              {site.custom_domain && (
                                <div className="flex items-center gap-1">
                                  <div className="i-ph:globe w-3 h-3 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                                  <span>Custom Domain</span>
                                </div>
                              )}
                              {site.branch && (
                                <div className="flex items-center gap-1">
                                  <div className="i-ph:code w-3 h-3 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                          ...
                          {activeSiteIndex === index && (
                            <>
                              <div className="mt-4 pt-3 border-t border-nova-elements-borderColor">
                                <div className="flex items-center gap-2">
                                  {siteActions.map((action) => (
                                    ...
                                    >
                                      <div
                                        className={`${action.icon} w-4 h-4 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent`}
                                      />
                                      {action.name}
                                    </Button>
                                  ))}
                              ...
                              {site.published_deploy && (
                                <div className="mt-3 text-sm">
                                  <div className="flex items-center gap-1">
                                    <div className="i-ph:clock w-4 h-4 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                                    <span className="text-nova-elements-textSecondary dark:text-nova-elements-textSecondary">
                                      Published {formatDistanceToNow(new Date(site.published_deploy.published_at))} ago
                                    </span>
                                  </div>
                                  {site.published_deploy.branch && (
                                    <div className="flex items-center gap-1 mt-1">
                                      <div className="i-ph:code w-4 h-4 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                                      <span className="text-nova-elements-textSecondary dark:text-nova-elements-textSecondary">
                    ...
                    <div className="bg-nova-elements-background dark:bg-nova-elements-background-depth-1 border border-nova-elements-borderColor dark:border-nova-elements-borderColor rounded-lg p-4">
                      ...
                      <div className="space-y-2">
                        {(isDeploysExpanded ? deploys : deploys.slice(0, 10)).map((deploy) => (
                          <div
                            key={deploy.id}
                            className="bg-nova-elements-background dark:bg-nova-elements-background-depth-1 border border-nova-elements-borderColor dark:border-nova-elements-borderColor rounded-lg p-3"
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <Badge
                              ...
                              <span className="text-xs text-nova-elements-textSecondary dark:text-nova-elements-textSecondary">
                                {formatDistanceToNow(new Date(deploy.created_at))} ago
                              </span>
                            </div>
                            {deploy.branch && (
                              <div className="mt-2 text-xs text-nova-elements-textSecondary dark:text-nova-elements-textSecondary flex items-center gap-1">
                                <div className="i-ph:code w-3 h-3 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                                <span className="text-nova-elements-textSecondary dark:text-nova-elements-textSecondary">
                            ...
                            {deploy.deploy_url && (
                              <div className="mt-2 text-xs">
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="flex items-center gap-1 transition-colors text-nova-elements-link-text hover:text-nova-elements-link-textHover dark:text-white dark:hover:text-nova-elements-link-textHover"
                                  onClick={(e) => e.stopPropagation()}
                                >
                                  <div className="i-ph:cloud w-3 h-3 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {deploy.state === 'ready' ? (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary"
                                >
                                  <div className="i-ph:lock-closed w-4 h-4 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                                  Lock
                                </Button>
                              ) : (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary"
                                >
                                  <div className="i-ph:lock-open w-4 h-4 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
                                  Unlock
                                </Button>
                              )}
                            </div>
                  ...
                  {connection.stats.builds && connection.stats.builds.length > 0 && (
                    <div className="bg-nova-elements-background dark:bg-nova-elements-background-depth-1 border border-nova-elements-borderColor dark:border-nova-elements-borderColor rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        <h4 className="text-sm font-medium flex items-center gap-2 text-nova-elements-textPrimary dark:text-nova-elements-textPrimary">
                          <div className="i-ph:hammer w-4 h-4 text-nova-elements-item-contentAccent dark:text-nova-elements-item-contentAccent" />
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-medium text-nova-elements-textPrimary dark:text-nova-elements-textPrimary">
            Netlify Integration
          </h2>
        </div>
        <div className="flex items-center gap-2">
          {connection.user && (
            <Button
              ...
              variant="outline"
              className="flex items-center gap-2 hover:bg-nova-elements-item-backgroundActive/10 hover:text-nova-elements-textPrimary dark:hover:bg-nova-elements-item-backgroundActive/10 dark:hover:text-nova-elements-textPrimary transition-colors"
            >
      ...
      <p className="text-sm text-nova-elements-textSecondary dark:text-nova-elements-textSecondary">
      ...
      <motion.div
        className="bg-nova-elements-background dark:bg-nova-elements-background border border-nova-elements-borderColor dark:border-nova-elements-borderColor rounded-lg"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        ...
        <div className="p-6">
          {!connection.user ? (
            <div className="space-y-4">
              <div className="text-xs text-nova-elements-textSecondary bg-nova-elements-background-depth-1 dark:bg-nova-elements-background-depth-1 p-3 rounded-lg mb-4">
                <p className="flex items-center gap-1 mb-1">
                  <span className="i-ph:lightbulb w-3.5 h-3.5 text-nova-elements-icon-success dark:text-nova-elements-icon-success" />
                  <span className="font-medium">Tip:</span> You can also set the{' '}
                  <code className="px-1 py-0.5 bg-nova-elements-background-depth-2 dark:bg-nova-elements-background-depth-2 rounded">
              ...
              <div>
                <label className="block text-sm text-nova-elements-textSecondary dark:text-nova-elements-textSecondary mb-2">
                  API Token
                </label>
                <input
                  type="password"
                  ...
                  className={classNames(
                    ...
                    'text-nova-elements-textPrimary placeholder-nova-elements-textTertiary',
                    'focus:outline-none focus:ring-1 focus:ring-nova-elements-borderColorActive',
                    'disabled:opacity-50',
                  )}
                />
                <div className="mt-2 text-sm text-nova-elements-textSecondary">
                  <a
                    href="https://app.netlify.com/user/applications#personal-access-tokens"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-nova-elements-borderColorActive hover:underline inline-flex items-center gap-1"
                  >
                    Get your token
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-nova-elements-textSecondary flex items-center gap-1">
                  <div className="i-ph:check-circle w-4 h-4 text-green-500" />
