    ...
    <div className="space-y-4">
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-2 pl-10 rounded-lg bg-nova-elements-background-depth-2 border border-nova-elements-borderColor text-nova-elements-textPrimary placeholder-nova-elements-textTertiary focus:outline-none focus:ring-1 focus:ring-nova-elements-borderColorActive"
        />
        <div className="absolute left-3 top-1/2 -translate-y-1/2">
          {isSearching ? (
            <div className="i-ph:spinner animate-spin w-4 h-4 text-nova-elements-textSecondary" />
          ) : (
            <div className="i-ph:magnifying-glass w-4 h-4 text-nova-elements-textSecondary" />
          )}
        </div>
      </div>
      ...
      <div className="space-y-4">
        {filteredRepositories.length === 0 ? (
          <div className="text-center py-8 text-nova-elements-textSecondary">
