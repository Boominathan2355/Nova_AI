    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          <GitLabLogo />
          <h2 className="text-lg font-medium text-nova-elements-textPrimary">GitLab Integration</h2>
        </div>
        <div className="flex items-center justify-center p-4">
          <div className="flex items-center gap-2">
            <div className="i-ph:spinner-gap-bold animate-spin w-4 h-4" />
            <span className="text-nova-elements-textSecondary">Loading...</span>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      {connection?.user && (
        ...
        >
          <div className="flex items-center gap-4 p-4 bg-nova-elements-background-depth-1 rounded-lg">
            <div className="w-12 h-12 rounded-full border-2 border-nova-elements-item-contentAccent flex items-center justify-center bg-nova-elements-background-depth-2 overflow-hidden">
              ...
              connection.user.avatar_url !== '' ? (
                ...
                <div className="w-full h-full rounded-full bg-nova-elements-item-contentAccent flex items-center justify-center text-white font-semibold text-sm">
            ...
            <div>
              ...
              <p className="text-sm text-nova-elements-textSecondary">{connection.user?.username}</p>
            </div>
          </div>
        </motion.div>
      )}
      ...
      {connection?.stats && (
        <motion.div
          ...
          className="border-t border-nova-elements-borderColor pt-6"
        >
          <h3 className="text-base font-medium text-nova-elements-textPrimary mb-4">Statistics</h3>
          <StatsDisplay
