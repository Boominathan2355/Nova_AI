  ...
  return (
    <div
      className={classNames(
        'space-y-4 p-4 bg-nova-elements-background-depth-1 border border-nova-elements-borderColor rounded-lg',
        className,
      )}
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Database className="w-4 h-4 text-nova-elements-item-contentAccent" />
          <h3 className="text-sm font-medium text-nova-elements-textPrimary">GitHub Cache Management</h3>
        </div>
      ...
      {showStats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div className="bg-nova-elements-background-depth-2 p-3 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              <HardDrive className="w-3 h-3 text-nova-elements-textSecondary" />
              <span className="text-xs font-medium text-nova-elements-textSecondary">Total Size</span>
            </div>
            <p className="text-sm font-semibold text-nova-elements-textPrimary">
          ...
          <div className="bg-nova-elements-background-depth-2 p-3 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              <Database className="w-3 h-3 text-nova-elements-textSecondary" />
              <span className="text-xs font-medium text-nova-elements-textSecondary">Entries</span>
            </div>
            <p className="text-sm font-semibold text-nova-elements-textPrimary">{cacheStats.totalEntries}</p>
          </div>

          <div className="bg-nova-elements-background-depth-2 p-3 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              <Clock className="w-3 h-3 text-nova-elements-textSecondary" />
              <span className="text-xs font-medium text-nova-elements-textSecondary">Oldest</span>
            </div>
          ...
          <div className="bg-nova-elements-background-depth-2 p-3 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              <CheckCircle className="w-3 h-3 text-nova-elements-textSecondary" />
              <span className="text-xs font-medium text-nova-elements-textSecondary">Status</span>
            </div>
      ...
      {cacheEntries.length > 0 && (
        <div className="space-y-2">
          <h4 className="text-xs font-medium text-nova-elements-textSecondary">
          ...
          <div className="space-y-2 max-h-48 overflow-y-auto">
            {cacheEntries.map((entry) => (
              <div
                key={entry.key}
                className="flex items-center justify-between p-2 bg-nova-elements-background-depth-2 rounded border border-nova-elements-borderColor"
              >
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-medium text-nova-elements-textPrimary truncate">
      ...
      <div className="flex flex-wrap gap-2 pt-2 border-t border-nova-elements-borderColor">
        <Button
          variant="outline"
          size="sm"
