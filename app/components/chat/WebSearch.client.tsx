...
export function WebSearch({ onSearchResult, disabled = false }: WebSearchProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        {isSearching ? (
          <div className="i-svg-spinners:90-ring-with-bg text-nova-elements-loader-progress text-xl animate-spin" />
        ) : (
      ...
      {isOpen && (
        <div
          className={classNames(
            ...
            'rounded-lg border border-nova-elements-borderColor bg-nova-elements-background-depth-2 p-2 shadow-lg',
          )}
        >
          <input
            ref={inputRef}
            ...
            className={classNames(
              ...
              'bg-nova-elements-background-depth-1 text-nova-elements-textPrimary',
              'placeholder-nova-elements-textTertiary',
          ...
          <button
            ...
            className={classNames(
              ...
              'bg-nova-elements-button-primary-background text-nova-elements-button-primary-text',
