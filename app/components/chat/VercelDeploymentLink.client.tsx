  ...
  useEffect(() => {
    async function fetchProjectData() {
      ...
      try {
        ...
        const project = projects.find((p: { name: string | string[] }) => p.name.includes(`Nova-${chatNumber}`));
      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          <a
            ...
            className="inline-flex items-center justify-center w-8 h-8 rounded hover:bg-nova-elements-item-backgroundActive text-nova-elements-textSecondary hover:text-[#000000] z-50"
            onClick={(e) => {
              e.stopPropagation();
            }}
          >
