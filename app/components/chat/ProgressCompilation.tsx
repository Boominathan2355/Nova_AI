      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-nova-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-nova-elements-item-backgroundAccent hover:bg-nova-elements-artifacts-backgroundHover"
