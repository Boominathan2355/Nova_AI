...
export const ModelSelector = ({
  ...
  if (providerList.length === 0) {
    return (
      <div className="mb-2 p-4 rounded-lg border border-nova-elements-borderColor bg-nova-elements-prompt-background text-nova-elements-textPrimary">
      ...
      <div className="relative flex w-full" onKeyDown={handleProviderKeyDown} ref={providerDropdownRef}>
        <div
          className={classNames(
            'w-full p-2 rounded-lg border border-nova-elements-borderColor',
            'bg-nova-elements-prompt-background text-nova-elements-textPrimary',
            'focus-within:outline-none focus-within:ring-2 focus-within:ring-nova-elements-focus',
            'transition-all cursor-pointer',
            isProviderDropdownOpen ? 'ring-2 ring-nova-elements-focus' : undefined,
          )}
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div
              className={classNames(
                'i-ph:caret-down w-4 h-4 text-nova-elements-textSecondary opacity-75',
        ...
        {isProviderDropdownOpen && (
          <div
            className="absolute z-20 w-full mt-1 py-1 rounded-lg border border-nova-elements-borderColor bg-nova-elements-background-depth-2 shadow-lg"
            role="listbox"
            id="provider-listbox"
          >
              ...
              <div className="relative">
                <input
                  ...
                  className={classNames(
                    ...
                    'bg-nova-elements-background-depth-2 border border-nova-elements-borderColor',
                    'text-nova-elements-textPrimary placeholder:text-nova-elements-textTertiary',
                    'focus:outline-none focus:ring-2 focus:ring-nova-elements-focus',
                    'transition-all',
                  )}
                ...
                <div className="absolute left-2.5 top-1/2 -translate-y-1/2">
                  <span className="i-ph:magnifying-glass text-nova-elements-textTertiary" />
                </div>
                {providerSearchQuery && (
                  <button
                    type="button"
                    ...
                    className="absolute right-2.5 top-1/2 -translate-y-1/2 p-0.5 rounded hover:bg-nova-elements-background-depth-3 transition-colors"
                    aria-label="Clear search"
                  >
                    <span className="i-ph:x text-nova-elements-textTertiary text-xs" />
                  </button>
                )}
              </div>
            </div>
            ...
            <div
              className={classNames(
                ...
                '[&::-webkit-scrollbar-thumb]:bg-nova-elements-borderColor',
                '[&::-webkit-scrollbar-thumb]:hover:bg-nova-elements-borderColorHover',
                '[&::-webkit-scrollbar-thumb]:rounded-full',
                '[&::-webkit-scrollbar-track]:bg-nova-elements-background-depth-2',
                '[&::-webkit-scrollbar-track]:rounded-full',
                'sm:[&::-webkit-scrollbar]:w-1.5 sm:[&::-webkit-scrollbar]:h-1.5',
                'sm:hover:[&::-webkit-scrollbar-thumb]:bg-nova-elements-borderColor/50',
                'sm:hover:[&::-webkit-scrollbar-thumb:hover]:bg-nova-elements-borderColor',
                'sm:[&::-webkit-scrollbar-track]:bg-transparent',
              )}
            >
              {filteredProviders.length === 0 ? (
                <div className="px-3 py-3 text-sm">
                  <div className="text-nova-elements-textTertiary mb-1">
                    {debouncedProviderSearchQuery
                      ? `No providers match "${debouncedProviderSearchQuery}"`
                      : 'No providers found'}
                  </div>
                  {debouncedProviderSearchQuery && (
                    <div className="text-xs text-nova-elements-textTertiary">
                ...
                filteredProviders.map((providerOption, index) => (
                  <div
                    ...
                    className={classNames(
                      ...
                      'hover:bg-nova-elements-background-depth-3',
                      'text-nova-elements-textPrimary',
                      'outline-none',
                      provider?.name === providerOption.name || focusedProviderIndex === index
                        ? 'bg-nova-elements-background-depth-2'
                        : undefined,
                      focusedProviderIndex === index ? 'ring-1 ring-inset ring-nova-elements-focus' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
      ...
      <div className="relative flex w-full min-w-[70%]" onKeyDown={handleModelKeyDown} ref={modelDropdownRef}>
        <div
          className={classNames(
            ...
            'focus-within:outline-none focus-within:ring-2 focus-within:ring-nova-elements-focus',
            'transition-all cursor-pointer',
            isModelDropdownOpen ? 'ring-2 ring-nova-elements-focus' : undefined,
          )}
        ...
        {isModelDropdownOpen && (
          <div
            className="absolute z-10 w-full mt-1 py-1 rounded-lg border border-nova-elements-borderColor bg-nova-elements-background-depth-2 shadow-lg"
            role="listbox"
            id="model-listbox"
          >
            <div className="px-2 pb-2 space-y-2">
              ...
              {provider?.name === 'OpenRouter' && (
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={classNames(
                      ...
                      showFreeModelsOnly
                        ...
                        : 'bg-nova-elements-background-depth-3 text-nova-elements-textSecondary border border-nova-elements-borderColor',
                    )}
                  >
                  ...
                  {showFreeModelsOnly && (
                    <span className="text-xs text-nova-elements-textTertiary">
              ...
              {debouncedModelSearchQuery && filteredModels.length > 0 && (
                <div className="text-xs text-nova-elements-textTertiary px-1">
            ...
            >
              {modelLoading === 'all' || modelLoading === provider?.name ? (
                <div className="px-3 py-3 text-sm">
                  <div className="flex items-center gap-2 text-nova-elements-textTertiary">
                ...
                <div className="px-3 py-3 text-sm">
                  ...
                  {!debouncedModelSearchQuery && provider?.name && LOCAL_PROVIDERS.includes(provider.name) && (
                    <div className="text-xs text-nova-elements-textTertiary mt-1">
                      Make sure {provider.name} is running and has at least one model loaded.
                      {provider.name === 'LlamaCpp' && ' Start the server: llama-server -m model.gguf --port 8080'}
                  ...
                  <div
                    ...
                    className={classNames(
                      ...
                      model === modelOption.name || focusedModelIndex === index
                        ? 'bg-nova-elements-background-depth-2'
                        : undefined,
                      focusedModelIndex === index ? 'ring-1 ring-inset ring-nova-elements-focus' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
