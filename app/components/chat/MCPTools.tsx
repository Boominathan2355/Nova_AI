      ...
      <div className="flex">
        ...
        >
          {!isInitialized ? (
            ...
            <div className="i-nova:mcp text-xl"></div>
          )}
        </IconButton>
      </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {serverEntries.length > 0 ? (
                    ...
                    <div className="py-4 text-center text-nova-elements-textSecondary">
                ...
                <div>{error && <p className="mt-2 text-sm text-nova-elements-icon-error">{error}</p>}</div>
              </div>
