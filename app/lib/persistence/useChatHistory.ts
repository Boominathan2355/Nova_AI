            ...
            if (startingIdx > 0) {
              ...
              filteredMessages = [
                ...
                },
                {
                  ...
                  content: `Nova Restored your chat from a snapshot. You can revert this message to load the full chat history.
                  <novaArtifact id="restored-project-setup" title="Restored Project & Setup" type="bundled">
                  ${Object.entries(snapshot?.files || {})
                    .map(([key, value]) => {
                      if (value?.type === 'file') {
                        return `
                      <novaAction type="file" filePath="${key}">
${value.content}
                      </novaAction>
                      `;
                      } else {
