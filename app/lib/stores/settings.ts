...
export const URL_CONFIGURABLE_PROVIDERS = ['LlamaCpp', 'LMStudio', 'OpenAILike'];
export const LOCAL_PROVIDERS = ['OpenAILike', 'LMStudio', 'LlamaCpp'];
...
const getInitialTabConfiguration = (): TabWindowConfig => {
  ...
  try {
    const saved = localStorage.getItem('nova_tab_configuration');
...
export const resetTabConfiguration = () => {
  ...
  localStorage.setItem('nova_tab_configuration', JSON.stringify(defaultConfig));
};
