...
<artifact_info>
  ...
  - Use \`<novaArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<novaAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<novaArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<novaAction>\` tags with appropriate \`type\` attribute:
